...
```
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspCorrelation heatmap was created to understand the correction between all the variables and the columns that are not important are removed from the dataset.
```
